...
COMPANY_CONTEXT = """
【公司背景与核心理念】
DJJ是一家总部位于澳大利亚的综合性公司，业务涵盖叉车租赁与销售及多个职能部门。

这次AI创新评选，不仅仅是一次活动，而是DJJ推动整个组织进入AI时代的重要起点。
公司的核心价值观：开放 · 成长 · 创新 · 长期。

【重要：评审范围不限于任何特定业务】
本次评选面向全公司所有岗位和业务方向，包括但不限于：
销售、客服、运营、财务、维修、行政、市场、HR、IT、
组织管理、团队协同、流程优化、系统建设、数据分析、
培训与知识沉淀、自动化、内容创作等。

无论作品来自哪个部门、解决哪类问题，只要真正帮助了
工作方式升级、效率提升、组织能力建设或长期价值沉淀，
均属于高价值方向，同等对待。
